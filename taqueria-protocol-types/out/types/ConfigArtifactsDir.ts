...
import { configArtifactsDirSchema } from '@taqueria/protocol-types/out/types-zod';
import { ConfigArtifactsDir } from '@taqueria/protocol-types/types';
...
export const make = (
	input: Omit<ConfigArtifactsDirStrict, '__type'>,
): FutureInstance<TaqError, ConfigArtifactsDirStrict> => of(input);
