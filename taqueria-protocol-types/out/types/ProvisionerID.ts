...
import { provisionerIDSchema } from '@taqueria/protocol-types/out/types-zod';
import { ProvisionerID } from '@taqueria/protocol-types/types';
...
export const make = (input: Omit<ProvisionerIDStrict, '__type'>): FutureInstance<TaqError, ProvisionerIDStrict> =>
	of(input);
