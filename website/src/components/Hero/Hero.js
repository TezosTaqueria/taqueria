...
const FeatureList = [
    {
        ...
        description: (
            <>
                Taqueria provides a seamless development workflow to easily build, test and deploy your Tezos
                applications.
            </>
        ),
        link: {
            ...
            <div className={styles.carousel}>
                ...
                <div className={styles.videoBlock}>
                    ...
                    {features.map((feature, index) => {
                        return (
                            isVisible === feature.title && <video key={index} autoPlay={true} muted src={feature.gif} />
                        )
                    })}
                </div>
