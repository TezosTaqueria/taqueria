...
|Release Type | Minor         |
|Release Page | [v0.22.1](https://github.com/ecadlabs/taqueria/releases/tag/v0.22.1) |
...
- 🚀 PR ➾ Release Taqueria v0.22.1 by @hu3man in [#1393](https://github.com/ecadlabs/taqueria/pull/1393)

**Full Changelog**: https://github.com/ecadlabs/taqueria/compare/v0.20.2...v0.22.1
