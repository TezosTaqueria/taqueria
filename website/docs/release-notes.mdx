...
|Release Type | Minor         |
|Release Page | [v0.28.6](https://github.com/pinnacle-labs/taqueria/releases/tag/v0.28.6) |
...
- `compile-all` task works as expected

##### Flextesa plugin
- Supports the Mumbai protocol

** Full Changelog: https://github.com/pinnacle-labs/taqueria/compare/v0.28.4...0.28.6
...
|Release Type | Minor         |
|Release Page | [v0.28.4](https://github.com/pinnacle-labs/taqueria/releases/tag/v0.28.4) |
...
** Full Changelog: https://github.com/pinnacle-labs/taqueria/compare/v0.28.3...0.28.4
...
|Release Type | Minor         |
|Release Page | [v0.28.3](https://github.com/pinnacle-labs/taqueria/releases/tag/v0.28.3) |
...
* 🛠️ Fix ➾ Don't require sandbox name for any task by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1844
* 🛠️ Fix ➾ Ensure that files created by ligo/docker aren't owned by root by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1845
* 🛠️ Fix ➾ Add restart sandbox task
* 🛠️ Fix ➾ Ensure that all taquito tasks will retry until max timeout elapsed by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1847
* 🧽 Chore ➾ add two tests for ligo compile file handling by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1817

** Full Changelog: https://github.com/pinnacle-labs/taqueria/compare/v0.28.2...0.28.3
...
|Release Type | Minor         |
|Release Page | [v0.28.2](https://github.com/pinnacle-labs/taqueria/releases/tag/v0.28.2) |
...
** Full Changelog: https://github.com/pinnacle-labs/taqueria/compare/v0.28.0...v0.28.2
...
|Release Page | [v0.28.0](https://github.com/pinnacle-labs/taqueria/releases/tag/v0.28.0) |
...
Taqueria can now create test stubs for Contracts. This capability has also been surfaced in the [VSCode Extension](https://marketplace.visualstudio.com/items?itemName=PinnacleLabs.taqueria-vscode).
...
The Taqueria [VSCode Extension](https://marketplace.visualstudio.com/items?itemName=PinnacleLabs.taqueria-vscode) now supports syntax highlighting in LIGO.
...
The [VSCode Extension](https://marketplace.visualstudio.com/items?itemName=PinnacleLabs.taqueria-vscode) continues to go from strength to strength. Here are the highlights:
...
* 🛠️ Fix ➾ Don't log scaffold.json contents when scaffolding by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1545
* Fixes to build process by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1530
* Correctly source environment variable in Linux runners by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1558
* 🛠️ Fix ➾ Set TAQ_VERSION and BUILD in one script to unify CI and local build and test by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1560
* ✨ Feature ➾ Provide LIGO syntax highlighting support in VSCode extension by @MichalLytek in https://github.com/pinnacle-labs/taqueria/pull/1514
* ✨ Feature ➾ Improve SmartPy Workflow for Contract and storage compilations by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1551
* 🛠️ Fix ➾ Clean all docker containers before running any tests by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1571
* Improve output when checking Dependencies, Remove dependency of tests step on build-binaries by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1557
* Fixes #1363, Adds import-map to test:unit:deno:debug task by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1568
* Fixed problem with undefined-state.json files getting generated by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1577
* Refactor protocol by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1550
* Add Generate Test Stub command to the VsCode Extension, Fix Existing Test Commands by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1582
* Open Contracts and Artifacts when double-clicking a TreeViewItem in Taqueria sidebar by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1583
* Fix: Change Container Name in VsCode Extension to Match Flextesa Plugin by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1584
* ✨ Feature ➾ Add `.gitignore` file upon taq init by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1585
* Fix: Have TzKt.Api do more retries for Database Schema before failing by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1612
* 🧽 Chore ➾ Downgrade Deno version to v1.23.1 in GH Workflows by @danielelisi in https://github.com/pinnacle-labs/taqueria/pull/1610
* Reduce vscode error messages while starting the Sandbox and when TreeViewItems are being refreshed by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1588
* Mk 1578 ligo plugin unit tests by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1579
* Check for deno version by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1589
* Rewrite tests in taqueria-cli-init and taqueria-cli-other to use cli-test-library by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1587
* Refactor tasks to not fork, and always run in-process of the main execution pipeline by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1613
* ✨ Feature ➾ allow users to specify a workflow so that a Taqueria project will come with all the important plugins 
pre-installed by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1621
* 🛠️ Fix ➾ Interpretation and parsing of boolean options given to a plugin by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1638
* ✨ Feature ➾ added ability to override versions in SmartPy and fix error reporting issue during SmartPy compile and test by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1648
* 🛠️ Fix ➾ Use default location for Deno dependency caching by @danielelisi in https://github.com/pinnacle-labs/taqueria/pull/1655
* 🛠️ Fix ➾ Added instructions to help users verify that they have taq installed by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1632
* Remove redundant warning by @egarson in https://github.com/pinnacle-labs/taqueria/pull/1657
* 🛠️ Fix ➾ Remove parcel and lmdb (and indirectly clang) as dev dependencies by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1640
* updated ligo plugin E2E tests by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1630
* ✨ Feature ➾ added ability to deploy to mainnet and interact with Contracts deployed there by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1658
* 👷 Refactor ➾ Don't auto install CORE plugin upon `taq init` unless `--workflow` flag is specified by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1665
* ✨ Feature ➾ 1162, Add baking options to flextesa plugin by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1645
* Taquito Plugin E2E Tests - update by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1631
* Ligo Plugin E2E Tests - improvements  by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1663
* Metadata Plugin E2E Tests - rewrite by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1661
* Contract Types Plugin E2E Tests - rewrite by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1660
* 🛠️ Fix ➾ Recompute ephemeral state after installing/uninstalling a plugin by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1699
* 🛠️ Fix ➾ Don't generate ephemeral state twice when installing/uninstalling plugins by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1702
* Fix Failure in TzKt.Sync by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1698
* 🛠️ Fix ➾ Use the hash of the latest protocol supported by the image as opposed to using Alpha by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1703
* Tezos-client plugin - test rewrite by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1672
* revised e2e test files for the  Archetype Plugin by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1679
* Flextesa Plugin E2E Tests - rewrite by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1668
* remove taqueria-plugin-multiple-test-plugins.spec.ts and moved its test to smoke tests by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1690
* reorganized some tests files from e2e to integration by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1681
* Mk 1676 revise e2e tests for smartpy plugin by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1693
* revised the e2e tests for jest plugin by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1685
* revised the persistent state e2e tests by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1683
* cleanup and organization of some E2E tests by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1712
* skip flaky jest plugin test by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1717
* Config.json schema update by @ricklove in https://github.com/pinnacle-labs/taqueria/pull/1604
* Mk 1710 revise e2e tests for taqueria registered Contracts plugin by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1721
* Mk 1709 revise e2e tests for ipfs plugin by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1720
* 🛠️ Fix ➾Updated beta warning text by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1705
* 🧽 Chore ➾ SDK was missing tsup as a dependency by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1707
* 🛠️ Fix ➾ Added better error handling to the SDK by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1706
* Mk 1719 move two jest plugin tests to integration by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1725
* 🛠️ Fix ➾ Traverse directories to search for a taqueria project by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1662
* 🛠️ Fix ➾ Update release-notes to remove 0.22.2 at start  by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/1726
* ✨ Feature ➾ Allow scaffold to target a git branch by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1732
* deleted the permissions integration test file by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1734
* reorganized test data files by type and deleted unused data files by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1729
* replaced protocol in test data from k to Lima by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1728
* remove deprecated files from e2e test directory by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1727
* quickstart scenario in e2e smoke test by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1724
* remove pinata preset requirement by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1739
* fix mac mini problem with taquito plugin install timing by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1740
* revise test readme and remove some unneeded ts.config by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1743
* added workflow tests by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1745
* revised the tests readmes by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1748
* 🛠️ Fix ➾ Check Npm and Node Versions when building by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1731
* 👷 Refactor ➾ Refactored google analytics code by separating functionality into a separate package by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1741
* Changed the names of tests by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1751
* Added a e2e fast mode by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1752
* Reconciled skipped tests with logged issues by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1755
* Use official TzKt images by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1759
* 🛠️ Fix ➾ Added analytics event tracking to vscode by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1757
* extend coverage for  e2e tests for plugin cli options by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1762
* 🚧 Dev ➾ Support for external TZkT Instances that are not managed by the Flextesa plugin to the VScE UI by @MichalLytek in https://github.com/pinnacle-labs/taqueria/pull/1637
* add marigold training1 example to E2E tests by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1765
* 🛠️ Fix ➾ During Contract type generation, exclude all non-contract files such as storage files by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1773
* ✨ Feature ➾ implement `taq compile-all` for the LIGO and SmartPy plugin by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1783
* 👷 Refactor ➾ Adjusted @taqueria/toolkit to be compatible with V1 and V2 configs by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1784
* 🛠️ Fix ➾ Fix Incorrect Version Number on Taqueria Homepage by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/1789
* Fix Monitoring for Changes in TVsCE by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1782
* Mk 1763 add marigold training1 by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1780
* Remove unwanted debugger statement by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1793
* Mk 1790 unskip repaired compile all Contracts tests by @michaelkernaghan in https://github.com/pinnacle-labs/taqueria/pull/1791
* Rollback TzKt to Ecad images by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/1795
* 🛠️ Fix ➾ Make compile and compile-all work when users exec them in contracts dir by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1787
* 🛠️ Fix ➾ execCmd should always reject with Error instance with stdout and stderr properties by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1799
* ✨ Feature ➾ Implement ability to set the default environment in the config file as a command by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1801
* 🛠️ Fix ➾ bug introduced in toErrorWithProps. Wrong return value. by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1805
* Adjust getContractsByTaqueriaConfig to work with new config V2 by @MichalLytek in https://github.com/pinnacle-labs/taqueria/pull/1798
* 👷 Refactor ➾ Added V2 API for the toolkit by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1792
* Implement Editor for NFT types: contract by @MichalLytek in https://github.com/pinnacle-labs/taqueria/pull/1803
* Config Docs Update (and config.local gitignore) by @ricklove in https://github.com/pinnacle-labs/taqueria/pull/1797
* 🛠️ Fix ➾ Issue #1802, sandbox accounts transformations by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1810
* ✨ Feature ➾ Implement typecheck-all by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/1812
* 🛠️ Fix ➾ Closes #1824, transfer task not finding aliases by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1826

**Full Changelog**: https://github.com/pinnacle-labs/taqueria/compare/v0.24.2...v0.27.17-rc
...
- 🚀 Release ➾ Taqueria v0.24.2 #1504 by @hu3man in [#1504](https://github.com/pinnacle-labs/taqueria/pull/1504)
...
- 👷 Refactor ➾ (ci) move tests to self-hosted Mac Minis by @GImbrailo in [#1509](https://github.com/pinnacle-labs/taqueria/pull/1509)
- 🛠️ Fix ➾ Remove `name` Field from `add-to-project` Action by @hu3man in [#1516](https://github.com/pinnacle-labs/taqueria/pull/1516)
parameter part"" by @hu3man in [#1522](https://github.com/pinnacle-labs/taqueria/pull/1522)
- 🛠️ Fix ➾ Clean up refactor and fix of docker image override by @jchenche in [#1513](https://github.com/pinnacle-labs/taqueria/pull/1513)
- 🛠️ Fix ➾ Update e2e test to reflect taco shop scaffold repo change by @jchenche in [#1524](https://github.com/pinnacle-labs/taqueria/pull/1524)
- Do not check for stopped container in e2e test by @jchenche in [#1534](https://github.com/pinnacle-labs/taqueria/pull/1534)
- To clarify for new users how to run the tests, surface test readme to main readme by @michaelkernaghan in [#1529](https://github.com/pinnacle-labs/taqueria/pull/1529)
- 🛠️ Fix ➾ (ci) added a build job for the vscode publish job by @GImbrailo in [#1515](https://github.com/pinnacle-labs/taqueria/pull/1515)
- Updated test readme to reflect build process by @alexzbusko in [#1525](https://github.com/pinnacle-labs/taqueria/pull/1525)
- made doc corrections to clarify adding contract to taco shop react app config by @michaelkernaghan in [#1527](https://github.com/pinnacle-labs/taqueria/pull/1527)
- Reintroduce maxWorker=1 for E2E Jest tests by @danielelisi in [#1531](https://github.com/pinnacle-labs/taqueria/pull/1531)
- Scaffolding memory leaks by @mweichert in [#1538](https://github.com/pinnacle-labs/taqueria/pull/1538)
- 🛠️ Fix ➾ (build) removed caching for build-docker by @GImbrailo in [#1468](https://github.com/pinnacle-labs/taqueria/pull/1468)
- 🧽 Chore ➾ Remove Unused Config Files and Skipped Tests that Depend on Them by @alexzbusko in [#1459](https://github.com/pinnacle-labs/taqueria/pull/1459)
- Fixes #1376, e2e tests config cleanup by @mweichert in [#1540](https://github.com/pinnacle-labs/taqueria/pull/1540)
- Update bug_report.yml by @hu3man in [#1543](https://github.com/pinnacle-labs/taqueria/pull/1543)
...
- 👷 Refactor ➾ (ci): Add Support for Alpha and Release Candidate Types via -alpha and -rc Tags to Prerelease Workflow by @GImbrailo in [#1423](https://github.com/pinnacle-labs/taqueria/pull/1423)
...
- Updating tests to make sure npm package.json is available in all test projects by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/899
- Implement missing functionality in TVsCE by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/947
- adding An to the allowlist for the CLA check by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/952
- fix: changed partition's config file to use relative path and updated e2e test accordingly by @hui-an-yang in https://github.com/pinnacle-labs/taqueria/pull/951
- added test for all michelson types and have taqueria point to taquito 13.0.1 by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/919
- Refactor scaffold task to use setup script by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/953
- Alex refactor cli commands into separate files by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/909
- Show error for all contracts that lack storage by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/950
- Enable all commands when config cannot be loaded by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/955
- change extension type to workspace by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/971
- Fixes #906, Added ability to register contracts by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/908
- Fixes #915, adds  template construct by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/946
- Ipfs Pinata Plugin by @ricklove in https://github.com/pinnacle-labs/taqueria/pull/938
- FIX taq runtime bug by @ricklove in https://github.com/pinnacle-labs/taqueria/pull/983
- Adjust compiler plugins to use registered contracts by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/981
- Refactor Scaffold Task by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/966
- Add contract template for Archetype by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/984
- Call scaffold.json's postInit script when setting up scaffold by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/993
- refactor: remove testing from release creation workflows by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/992
- chore: add deno-lock and deno package caching by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/982
- Skip running test that uses esm modules by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/994
- Adjust jest plugin to return appropriate exit code by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/995
- Don't look for scaffold.json file in .taq folder by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/996
- Fix scaffold verbosity by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1001
- Lock parcel to v2.6.1 by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1007
- implement a GUI by @AlirezaHaghshenas in https://github.com/pinnacle-labs/taqueria/pull/972
- SDK's getContracts method not honoring regex pattern by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/1011
- Taqueria v0.8.0 by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/999

## New Contributors
- @hui-an-yang made their first contribution in https://github.com/pinnacle-labs/taqueria/pull/951

**Full Changelog**: https://github.com/pinnacle-labs/taqueria/compare/v0.6.5...v0.8.0
...
|Release Type | Minor         |
|Release Page | [v0.3.1](https://github.com/pinnacle-labs/taqueria/releases/tag/v0.3.1) |

### What's Changed

- Create plugin-archetype by @hu3man in [603]https://github.com/pinnacle-labs/taqueria/pull/603
- added in tests for archetype plugin by @alexzbusko in [613]https://github.com/pinnacle-labs/taqueria/pull/485
- added in conditional to make sure that the tests will not run after a… by @alexzbusko in [613]https://github.com/pinnacle-labs/taqueria/pull/613
- Updated content for Archetypeee by @russellmorton in [616]https://github.com/pinnacle-labs/taqueria/pull/616
- Add network documentation by @hu3man in [624]https://github.com/pinnacle-labs/taqueria/pull/624
- added more information to e2e test failure notification by @alexzbusko in [628]https://github.com/pinnacle-labs/taqueria/pull/628
- Update quickstart with learnings from Zainen demo by @hu3man in [635]https://github.com/pinnacle-labs/taqueria/pull/635
- Fixes #512, uses bulk operations API for Taquito originations by @mweichert in [583]https://github.com/pinnacle-labs/taqueria/pull/583
- Fixes #557 typechecker and simulate task by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/618
- Turn LIGO Plugin from JS to TS by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/662
- Added set up for unit tests based on node e.g. taqueria-sdk by @sinapsist in https://github.com/pinnacle-labs/taqueria/pull/664
- Add plugin-tezos-client docs for website by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/672
- Update the quickstart.md file injected into new projects by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/671
- NFT Page  by @claudebarde in https://github.com/pinnacle-labs/taqueria/pull/681
- Added contract address for mainnet by @claudebarde in https://github.com/pinnacle-labs/taqueria/pull/689
- Website Content Updates by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/685
- Update bcd link by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/690
- made installs for plugins default to local by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/614
- added step to matrix on test chunking by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/680
- Make sure to Typecheck every file and fix type errors by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/682
- Website updates by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/692
- Fixes #714, M1 architecture detection by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/715
- Add support for chest in contract type plugin by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/718

## New Contributors
- @claudebarde made their first contribution in https://github.com/pinnacle-labs/taqueria/pull/681

**Full Changelog**: https://github.com/pinnacle-labs/taqueria/compare/v0.2.1...v0.3.1
...
|Release Type | Minor         |
|Release Page | [v0.2.1](https://github.com/pinnacle-labs/taqueria/releases/tag/v0.2.1) |

### What's Changed

- Update GA property to UA by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/413
- Fix for CI built binaries version test by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/414
- Update docusaurus to use GA classic plugin by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/416
- Fix GA tagging issues by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/424
- Bump docusaurus version by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/423
- Adding taquito plugin tests to verify that contract(s) can be deployed. by @sinapsist in https://github.com/pinnacle-labs/taqueria/pull/314
- Add build dependencies to readme.md by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/421
- Add taqueria team as codeowners for readme.md file by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/396
- Swap GA4 tag to legacy by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/440
- Update docusaurus.config.js by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/441
- Implement type generator plugin docs by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/398
- Implement robots.txt, sitemap, and GSC integration by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/454
- Force docusaurus to generate trailing slash on static site gen by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/463
- rafactor(ci): Only run-tests job for PRs from a fork by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/461
- Update robots.txt file to disallow CDN pages by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/476
- Install dynamic sitemap generator plugin for Docusaurus by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/477
- add hover effect and style for headline in navbar by @HamidGoudarzi1988 in https://github.com/pinnacle-labs/taqueria/pull/481
- Fix 308 redirect issue by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/480
- Update roadmap by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/451
- Update site, docusaurus, and plugins to v17 by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/483
- Update README.md  by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/395
- Implement newcomer doc #1 by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/452
- Install Docusaurus-Terminology and Migrate Website to Use Yarn by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/490
- Update README.md for Website With New Build Steps by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/499
- feat(ci): add cla assistant to workflows for external contributions by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/501
- added in step to notify channel when e2e tests fail by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/500
- Add description flextesa tests by @sinapsist in https://github.com/pinnacle-labs/taqueria/pull/392
- feat(ci): add CodeQL workflows by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/518
- BUG FIX: Integer param names by @ricklove in https://github.com/pinnacle-labs/taqueria/pull/472
- Update CODEOWNERS by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/526
- added sdets as codeowners for tests directory by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/508
- Fixes #257, protocol refactor for improved stdout/stderr handling by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/465
- Fixes #408, adds @taqueria/flextesa-manager workspace and NPM package by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/434
- Fixes 251 use corresponding flextesa image by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/435
- Create SECURITY.md by @russellmorton in https://github.com/pinnacle-labs/taqueria/pull/389
- Contract type plugin fix 02 by @ricklove in https://github.com/pinnacle-labs/taqueria/pull/520
- chore(website): add build-wesite script to be run from the project root in CloudFlare pages by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/514
- fixing node version for tests to enable integration test to pass by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/553
- fix footer svg issue by @HamidGoudarzi1988 in https://github.com/pinnacle-labs/taqueria/pull/531
- Alex scaffolding cli tests by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/380
- Update VS Code readme by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/533
- 384 contract types generation tests by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/469
- removed sdet rule from codeowners by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/560
- Update code snippets by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/534
- Fixes an issue where the sitemap was not being generated on the CF builds, resulting in crawler errors by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/563
- fix(ci): change PR comment for docker workflow by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/573
- Update docker-publish.yml by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/574
- Closes #561 add missing typechecking to sdk and flextesa manager plugin by @jchenche in https://github.com/pinnacle-labs/taqueria/pull/570
- Fixes #576, removes json-schema-generator as dependency by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/577
- Alex asyncification of plugin tests by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/521
- updated init tests to check for basic components before starting a project by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/473
- NEW - Fixes #390, remove .git directory from scaffold by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/580
- added tests to ensure help contents for specific commands by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/475
- Fixes #578, e2e tests not running locally by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/579
- Fixes #363, adds Archetype plugin by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/581
- 379 alias testing taquito by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/489
- Added initial draft of design doc for state architecture. Fixes #548 by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/568

**Full Changelog**: https://github.com/pinnacle-labs/taqueria/compare/v0.1.2...v0.2.1
...
### What's Changed
- refactor(ci): remove git tag from binary names for release assets by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/152
- ci(docker): Add workflow to build and publish images by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/146
- Fixes #147, tasks not exposed in cli - among other changes by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/149
- fix(website): add redirects file for binary downloads by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/155
- Nav and footer style issue by @HamidGoudarzi1988 in https://github.com/pinnacle-labs/taqueria/pull/150
- chore: add .exe suffix for the windows binary by @jevonearth in https://github.com/pinnacle-labs/taqueria/pull/159
- chore: added pull request packages documentation by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/157
- ci: use `yarn` to package VSCode extension by @danielelisi in https://github.com/pinnacle-labs/taqueria/pull/163
- fix(ci): fix npm version name in pr-comment  by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/158
- added reusable workflow for publishing packages by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/156
- removing dependency for publishing protocol on binaries by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/165
- VSCode: Initial architecture and implementation for Phase 0 by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/162
- fix(ci): build flextesa dependency for docker by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/166
- fix(ci): npm official release publish version from package.json by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/167
- Use flextesa-plugin-use-ghcr-image in flextesa plugin by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/168
- Update README.md to reference binary as 'taq' not 'taqueria' by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/170
- Add taq version by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/173
- Fixes multiple issues with LIGO plugin by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/175
- Convert repo to use NPM workspaces by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/171
- Use expression to render env variables in VSCode pipeline by @danielelisi in https://github.com/pinnacle-labs/taqueria/pull/182
- Pre-format JSON before writing to .taq/config.json or .taq/state.json by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/172
- Alex main npm publish version fix by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/183
- FIX Npm PR Version by @ricklove in https://github.com/pinnacle-labs/taqueria/pull/184
- Web videos and VS Code extension description by @russellmorton in https://github.com/pinnacle-labs/taqueria/pull/174
- Installation Documentation by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/145
- chore: remove used by for timebeing by @jevonearth in https://github.com/pinnacle-labs/taqueria/pull/187
- refactor(ci): add next or latest tag depending on pre-release event by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/185
- Attempt to fix vscode packaging by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/189
- Add support for specifying package version in 'taq install' by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/191
- Documentation Improvements by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/188
- Issue template updates by @russellmorton in https://github.com/pinnacle-labs/taqueria/pull/190
- Remove contact details from bug_report.yml and feature_request.yml by @russellmorton in https://github.com/pinnacle-labs/taqueria/pull/195
- chore: remove trailing semicolon by @jevonearth in https://github.com/pinnacle-labs/taqueria/pull/197
- Rework of the Introduction page and other fixes by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/200
- Update feature request and bug report by @russellmorton in https://github.com/pinnacle-labs/taqueria/pull/196
- Setting up testing framework for unit, integration and e2e testing. by @sinapsist in https://github.com/pinnacle-labs/taqueria/pull/127
- removing starting path for docker by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/205
- Fix json encoding, flextesa plugin, ligo plugin, and vscode extension by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/203
- Update Main readme.md File by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/209
- Alex pr comment typo + updating PR package instructions to be taq instead of npm by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/208
- chore: correct docusarus config url by @jevonearth in https://github.com/pinnacle-labs/taqueria/pull/219
- VSCode: Fix child process execution on all platforms by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/217
- update Code of Conduct by @neilmangan in https://github.com/pinnacle-labs/taqueria/pull/224
- feat(ci): flexesa docker image on multiple platforms by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/207
- Fixes vscode windows detection by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/231
- ci(vscode): publish to VSCode marketplace when a GH release is published by @danielelisi in https://github.com/pinnacle-labs/taqueria/pull/223
- ci: update existing github-bot comment in PRs instead of creating new ones for each commit by @danielelisi in https://github.com/pinnacle-labs/taqueria/pull/276
- Fixes #273, LIGO compilation failures on Apple Silicon by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/274
- added in testing steps to main workflow by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/222
- 267 run unit tests on commit by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/299
- Fixes #250, use flextesa_node_cors_origin environment variable to disa… by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/306
- Fixes #295, installing a plugin in the VSCode extension by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/301
- Fixes #249,  conflicting vscode notifications after compile by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/303
- Add roadmap page by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/280
- Update readme.md files for npm packages by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/296
- docs: update contributor code of conduct to match repo by @neilmangan in https://github.com/pinnacle-labs/taqueria/pull/240
- Major Plugin Doc Improvements by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/238
- fix margin issue #220 by @HamidGoudarzi1988 in https://github.com/pinnacle-labs/taqueria/pull/230
- Migrate Site to Google Tag Manager by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/305
- Fixed LIGO plugin page by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/242
- Fixes #248, propgate storage up to VSCode by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/308
- Adding build step for SDK in integration tests by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/312
- ci: Use local template reference for Github reusable workflows by @danielelisi in https://github.com/pinnacle-labs/taqueria/pull/186
- Fixes #315, handle parcel segfaults by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/325
- Fixed type definition for Future by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/326
- CI Test by @ricklove in https://github.com/pinnacle-labs/taqueria/pull/329
- Fixes #330, type definitions incorrect for Fluture by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/331
- Contract Types Plugin - Initial Implementation by @ricklove in https://github.com/pinnacle-labs/taqueria/pull/91
- 228 taqueria cli commands testing by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/328
- Project Scaffold by @ricklove in https://github.com/pinnacle-labs/taqueria/pull/139
- Web copy fixes by @jevonearth in https://github.com/pinnacle-labs/taqueria/pull/334
- Renamed publicKey property for accounts to publicKeyHash. by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/356
- updated help contents for new scaffolding entries and message indenting by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/353
- Add houston, russell, and alex as code owners for /website/ by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/365
- Update install CTA link by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/348
- Revert to direct GA properties by @hu3man in https://github.com/pinnacle-labs/taqueria/pull/311
- Add styles css for docs by @HamidGoudarzi1988 in https://github.com/pinnacle-labs/taqueria/pull/317
- Flextesa plugin e2e tests by @sinapsist in https://github.com/pinnacle-labs/taqueria/pull/218
- fix for flextesa index.js not being available in pipeline by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/391
- Fix for building packages before running tests by @alexzbusko in https://github.com/pinnacle-labs/taqueria/pull/393
- chore(ci): vsix gcs upload and release by @GImbrailo in https://github.com/pinnacle-labs/taqueria/pull/310
- Fixes #264, adds commit hash to build and version output by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/402
- Update inner flextesa npm package to use latest version of SDK by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/412
- Fixes #406, removes quickstart from plugin arguments by @mweichert in https://github.com/pinnacle-labs/taqueria/pull/407

## New Contributors
- @neilmangan made their first contribution in https://github.com/pinnacle-labs/taqueria/pull/224

**Full Changelog**: https://github.com/pinnacle-labs/taqueria/compare/v0.0.1-rc1...v0.1.2
