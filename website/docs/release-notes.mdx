...
|Release Type | Minor         |
|Release Page | [v0.26.0](https://github.com/ecadlabs/taqueria/releases/tag/v0.26.0) |
...
To upgrade, you must download Taqueria v0.26.0 binary, replacing the legacy version
...
3) Download the appropriate Taqueria v0.26.0 binary for your operating system
...
You can update your existing projects to use Taqueria v0.26.0 plugins using the following command:
