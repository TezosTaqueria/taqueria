...
Taqueria is a software suite that includies a CLI interface, a library of Node.js plugins, and a VS Code extension. Each of these are installed separatley. 

A Taqueria installation can be as simple as just the Taqueria CLI, or a more standard installation which may include the VS Code extension and other common plugins.
