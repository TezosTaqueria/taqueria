...
- MacOS: zsh
- Linux: bash
- Windows: bash (via [WSL](https://docs.microsoft.com/en-us/windows/wsl/install))
...
We reccomend Windows users run [WSL](https://docs.microsoft.com/en-us/windows/wsl/install) and follow the instructions for Linux users
