...
Windows users will run the Linux version of Taqueria in Unbuntu using Windows Subsystem for Linux ([WSL2](https://docs.microsoft.com/en-us/windows/wsl/install))
...
2. Run the installer making sure to enable WSL 2during the installation when prompted
...
You should see `v16.15.0` or similar returned
