...
:::warning
Windows support is currently in alpha
:::

Windows users will run the Linux version of Taqueria via ([WSL2](https://docs.microsoft.com/en-us/windows/wsl/install)). Once WSL is installed and configured, the installation and usage steps are the same as for Linux:
