...
:::note
This document details the configuration and use of Tezos testnets. If you are looking for information on running or deploying to a sandbox, please see the Flextesa documentation [here](/docs/getting-started/plugins/flextesa/flextesa.md/))
:::
...
3. The [Taquito plugin](/docs/getting-started/plugins/taquito/taquito.md/) (Used for originating to a network)
      ...
      "ithica":{
         ...
         "faucet":{
            "key": {
                ...
                "password": "JTMMX6FPNL",
                "amount": "20064327205",
                "activation_code": "50fe648444288c8dd1fe1e976ca26160536fda97"
            }
         }
      }
   }
...
To target the `ithica` network we configured above using the `ithicanet` environment, we would run the following command:
```shell
