...
:::note
This document details the configuration and use of Tezos testnets. If you are looking for information on running or deploying to a sandbox, please see the Flextesa documentation [here](../docs/plugins/plugin-flextesa.mdx/)
:::
