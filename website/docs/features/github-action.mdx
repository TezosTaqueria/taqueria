...
The action GitHub repo for the project is located [here](https://github.com/pinnacle-labs/taqueria-github-action)

You can see the action being used on the [Taco Shop Scaffold](https://github.com/pinnacle-labs/taqueria-scaffold-taco-shop/blob/main/.github/workflows/main.yml)
