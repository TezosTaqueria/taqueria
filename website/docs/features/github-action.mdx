...
The action GitHub repo for the project is located [here](https://github.com/tezostaqueria/taqueria-github-action)

You can see the action being used on the [Taco Shop Scaffold](https://github.com/tezostaqueria/taqueria-scaffold-taco-shop/blob/main/.github/workflows/main.yml)
...
```yaml
- name: taqueria tasks
    uses: tezostaqueria/taqueria-github-action@v0.11.0
    with:
