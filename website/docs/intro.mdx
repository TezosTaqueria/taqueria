...
- Generating TypeScript types from a Michelson contract with the [Contract Types plugin](/docs/plugins/plugin-contract-types/), providing Taquito type safety and autocompletion in VS Code
