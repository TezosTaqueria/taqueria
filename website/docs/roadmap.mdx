...
:::note
For full detail on changes, fixes, and improvements made in each release, please refer to the [Taqueria Release Page](/releases/)
:::

- May 2022
  - Smart contract testing with the Jest plugin
  - Taqueria State
  - Implicit accounts
