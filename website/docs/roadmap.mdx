...
---
 ...
 >
 > NOTE: This roadmap is out-of-date and being revised.
 >
...
:::note
For full detail on changes, fixes, and improvements made in each release, please refer to the [Taqueria Release Page](https://github.com/tezostaqueria/taqueria/releases)
:::
