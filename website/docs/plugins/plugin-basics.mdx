...
| [Flextesa](./plugin-flextesa.mdx/)             | `@taqueria/plugin-flextesa`       | A Tezos sandbox (testnet) that runs locally on your machine         | 
| [Taquito](./plugin-taquito.mdx/)               | `@taqueria/plugin-taquito`        | A front-end Tezos framework used to originate smart contracts       |
...
| [Tezos Client](./plugin-tezos-client.mdx/)     | `@taqueria/plugin-tezos-client`   | Interacts with a Tezos node, providing simulation and type checking |