...
:::caution
This plugin is still in early development. Please submit issues and feature requests [here](https://github.com/pinnacle-labs/taqueria).
:::
...
Alternatively, you can use the `Getting Started with Taqueria and TzCompose` scaffold to quickly set up a project with Tzcompose integrated. Visit [https://github.com/pinnacle-labs/taqueria-getting-started-tzcompose-scaffold](https://github.com/pinnacle-labs/taqueria-getting-started-tzcompose-scaffold) to learn more.
