...
:::note
You can view the full example in the `example-usage.ts` file on Github: [example-usage.ts](https://github.com/tezostaqueria/taqueria/blob/main/taqueria-plugin-contract-types/example/example-usage.ts)
:::
