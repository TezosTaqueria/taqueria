...
The account balance represents the target balance for those accounts. The environment plugins will provide a mechanism to instantiate and maintain the balance for those account.
