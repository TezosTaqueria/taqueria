...
Taqueria provides a [starter project](https://github.com/pinnacle-labs/taqueria-scaffold-quickstart) that you can use to get up and running quickly by using the `taq scaffold` command
...
- You are using <NodeRequirement download/>
