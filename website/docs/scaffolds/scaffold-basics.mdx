...
|------------------------------|----------------------------------------------------------|--------------------------------------------------------|
| Getting Started with LIGO  | https://github.com/tezostaqueria/taqueria-getting-started-ligo-scaffold  | Simple scaffold to get off the ground quickly with LIGO |
| Taco Shop  | https://github.com/tezostaqueria/taqueria-scaffold-taco-shop  | Full stack dApp with a simple contract to sell tacos |
| Getting Started with TzCompose | https://github.com/tezostaqueria/taqueria-getting-started-tzcompose-scaffold | Deploy interdependent contracts with ease |