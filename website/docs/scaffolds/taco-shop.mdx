...
- A testnet account funded with a [faucet](https://teztnets.xyz)  
...
3. Insert the returned contract address into the React app
...
Now that the contract has been deployed and the address added to the app, you can build and start the React app:
