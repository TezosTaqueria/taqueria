...
This will clone the Taco Shop scaffold project into a directory called `taco-shop` and set up the project for you
...
Run the following command to originate the contract to the ghostnet testnet using the testing environment:
...
├────────────────┼──────────────────────────────────────┼────────────────┤
│ hello-tacos.tz │ KT1EHAXNQ1oeh2ZNTkvvcU6PfzQvGPLsgJx3 │ ghostnet       │
└────────────────┴──────────────────────────────────────┴────────────────┘
```
