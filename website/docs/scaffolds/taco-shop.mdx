...
| Repository         | https://github.com/pinnacle-labs/taqueria-scaffold-taco-shop |
...
1. `taq scaffold https://github.com/pinnacle-labs/taqueria-scaffold-taco-shop taco-shop`
1. `cd taco-shop`
1. `npm run setup`
1. `npm run start:app`
...
```shell
taq scaffold https://github.com/pinnacle-labs/taqueria-scaffold-taco-shop taco-shop
```
