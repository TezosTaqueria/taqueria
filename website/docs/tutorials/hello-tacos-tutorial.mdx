...
You will need to add storage for the contracts in the config.json file within the environment section. You can read more about it [here](/docs/config/environment)
