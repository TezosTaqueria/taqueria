...
describe('Ligo Plugin E2E Testing for Taqueria CLI', () => {
	...
	describe('support for smart contracts which use a main function but no namespace/module', () => {
		...
		test('compile should create a missing parameterList file for a contract that uses a main function and is not a module', async () => {
			...
			expect(compileResult.stderr[0]).toEqual(`Note: parameter file associated with "counter-main" can't be found, so "counter-main.parameterList.mligo" has been created for you. Use this file to define all parameter values for this contract`)
			...
			const expectedParameterFile = await (await exec(`cat e2e/data/ligo-data/expected-counter-main.parameterList.mligo`)).stdout;
	...
	describe('support for smart contracts which use a main function within a namespace/module', () => {
		...
		test('compile should create a missing parameterList file for a contract that uses a main function and in a namespace/module', async () => {
			...
			// Expect stderr to contain a warning about the missing parameter file
			expect(compileResult.stderr).toHaveLength(1);
			expect(compileResult.stderr[0]).toEqual(`Note: parameter file associated with "Counter" can't be found, so "Counter.parameterList.mligo" has been created for you. Use this file to define all parameter values for this contract`)
			...
			const expectedParameterFile = await (await exec(`cat e2e/data/ligo-data/expected-Counter.parameterList.mligo`)).stdout;
			expect(parameterFile).toEqual(expectedParameterFile);
	...
	describe('support for smart contracts which use @entry without a namespace/module', () => {
		...
		test('compile should create a missing parameterList file for a contract that uses @entry without a namespace/module', async () => {
			...
			// Expect stderr to contain a warning about the missing parameter file
			expect(compileResult.stderr).toHaveLength(1);
			expect(compileResult.stderr[0]).toEqual(`Note: parameter file associated with "entry" can't be found, so "entry.parameterList.jsligo" has been created for you. Use this file to define all parameter values for this contract`)
			...
			const expectedParameterFile = await (await exec(`cat e2e/data/ligo-data/expected-entry.parameterList.jsligo`)).stdout;
			expect(parameterFile).toEqual(expectedParameterFile);
	...
	describe('support for smart contracts which use @entry within a namespace/module', () => {
		...
		test('compile should create a missing parameterList file for a contract that uses @entry within a namespace/module', async () => {
			...
			// Expect stderr to contain a warning about the missing parameter file
			expect(compileResult.stderr).toHaveLength(1);
			expect(compileResult.stderr[0]).toEqual(`Note: parameter file associated with "IncDec" can't be found, so "IncDec.parameterList.jsligo" has been created for you. Use this file to define all parameter values for this contract`)
			...
			// console.log(parameterFile)
			const expectedParameterFile = await (await exec(`cat e2e/data/ligo-data/expected-IncDec.parameterList.jsligo`)).stdout;
			expect(parameterFile).toEqual(expectedParameterFile);
	...
	describe('other compilation tasks', () => {
		...
		test('compile will error if the named contract does not exist', async () => {
			...
			expect(compileOutput.join("\n")).toContain('│ does_not_exist.mligo │ No contract modules found in "does_not_exist.mligo"');
