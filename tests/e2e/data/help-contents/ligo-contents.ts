...
Commands:
  ...
  taq compile <sourceFile>        Compile a smart contract written in a LIGO syn
                                  ...
                                  ed storage list and parameter list files if th
                                  ey are found        [aliases: c, compile-ligo]
...
its associated storage list and parameter list files if they are found
